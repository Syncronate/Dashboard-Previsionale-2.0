...
GSHEET_PREDICTIONS_SHEET_NAME = os.environ.get("GSHEET_PREDICTIONS_SHEET", "Previsioni Thunder-ICON 24h")
GSHEET_FEATURE_IMPORTANCE_SHEET_NAME = os.environ.get("GSHEET_IMPORTANCE_SHEET", "TFT Feature Importance ICON 24h")
